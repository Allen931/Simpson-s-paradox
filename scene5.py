...
class SCENE5(Scene):
    def construct(self):
        ...
        lurking_variable = TextMobject("Lurking Variable").scale(3)
        self.play(Uncreate(why))
        self.wait()
        self.play(ShowIncreasingSubsets(lurking_variable[0], run_time=3))
        self.wait()
        self.play(ReplacementTransform(lurking_variable, elements))